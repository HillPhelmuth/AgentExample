...
public class SemanticKernelChatMessageContentConnector : IMiddleware, IStreamingMiddleware
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        await foreach (var reply in (await agent.GenerateStreamingReplyAsync(chatMessageContents, context.Options, cancellationToken)).WithCancellation(cancellationToken))
        {
