    ...
    public async Task<List<YouTubeSearchResult>> Search(string keyWords, int count = 10)
    {
        ...
        try
        {
           ...
           searchListRequest.Type = "video";
            ...
            var results = searchListResponse.Items.Select(searchResult => new YouTubeSearchResult(searchResult.Id.VideoId, searchResult.Snippet.Description) { Title = searchResult.Snippet.Title}).ToList();
            return results;
